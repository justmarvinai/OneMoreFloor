...
import { V7_ACCOUNT, V7_CHARACTER } from './fixtures/v7.ts';
...
const FIXTURES = [
  ...
  { version: 7, name: 'account', blob: V7_ACCOUNT, validate: isAccountRecord },
  { version: 7, name: 'character', blob: V7_CHARACTER, validate: isCharacterRecord },
] as const;
